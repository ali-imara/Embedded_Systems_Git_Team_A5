...
class PedestrianTrafficLight {
  ...
  public:
    ...
    bool isButtonPressed() {
      bool currentButtonState = digitalRead(irPin);
...
PedestrianTrafficLight pedLight(PED_GREEN_PIN, PED_RED_PIN, PED_IR_PIN);
...
if (danger){pedLight.setRed();}
  else if (carLight.isRed();) {
